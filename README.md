...
A reusable [Next.js](https://nextjs.org) (App Router) frontend template with authentication UI, a dashboard shell, settings pages, and Redux Toolkit Query wired up — ready to build a new product on top of.
...
- Set your brand in `src/config/site.ts` (name, title, description, URL) — this feeds SEO, sitemap, robots, and manifest.
- Replace the **YourBrand** placeholder in `src/components/shared/Navbar.tsx`, `Footer.tsx`, and the dashboard `Sidebar.tsx`.
